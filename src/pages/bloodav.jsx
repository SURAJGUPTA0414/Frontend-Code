...
const SearchBloodStock = () => {
  ...
  const handleBuyNow = (donor) => {
    alert(`Request sent to ${donor.full_name} for ${donor.blood_group} (${donor.blood_type})`);
  };
            ...
            <tbody>
              {results.map((donor) => (
                <tr key={donor.donor_id}>
                  ...
                  <td>{donor.blood_type}</td>
                  <td>
                    <button className="buy-button" onClick={()=>navigato('/razorpayhandler')}>
                      Buy Now
                    </button>
                  </td>
                </tr>
